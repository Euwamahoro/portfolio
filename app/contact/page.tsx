  ...
  const contactMethods = [
    {
      ...
      title: "Email",
      value: "enockdev01@gmail.com",
      action: "mailto:enockdev016@gmail.com",
      color: "neon-blue",
    },
    {
      icon: <FaLinkedin className="text-2xl" />,
      title: "LinkedIn",
      value: "linkedin.com/in/uwamahoro-enock",
      action: "https://www.linkedin.com/in/uwamahoro-enock/",
      color: "neon-green",
    },
    {
      icon: <FaGithub className="text-2xl" />,
      title: "GitHub",
      value: "github.com/Euwamahoro",
      action: "https://github.com/Euwamahoro",
      color: "neon-purple",
    },
    {
